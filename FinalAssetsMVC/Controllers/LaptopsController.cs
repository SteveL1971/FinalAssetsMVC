...
namespace FinalAssetsMVC.Controllers
{
    public class LaptopsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("TargetArea,Id,Brand,Model,Price")] Laptop laptop)
        {
            laptop.Type = "Laptop";
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("TargetArea,Id,Brand,Model,Price")] Laptop laptop)
        {
            if (id != laptop.Id)
            {
                return NotFound();
