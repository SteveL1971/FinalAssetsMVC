...
namespace FinalAssetsMVC.Controllers
{
    public class MobilesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Brand,Model,Price")] Mobile mobile)
        {
            mobile.Type = "Mobile";
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Brand,Model,Price,Type")] Mobile mobile)
        {
            if (id != mobile.Id)
            {
                return NotFound();
